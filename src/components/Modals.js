    ...
    <div className="modal-description">
      <div>
        ...
        <p>
          ...
          <br />
          <br />
          I am an avid user of Vim for everything from coding to note-taking and
          scratch, and am fascinated with shell and text editor customization.
          <br />
          Check out my{' '}
          <a
            className="highlight"
          ...
          listening to different music ranging from classic rock to contemporary
          jazz.
        </p>
      </div>
    </div>
...
const TwainModal = () => (
  <>
    <div className="modal-top">
      <img height="80%" src={TwainDate} alt="Twain date picker UI" />
      <img height="80%" src={TwainTime} alt="Twain time picker UI" />
    </div>
    <div className="modal-description">
      <div>
        <h2>
...
const RestockModal = () => (
  <>
    <div className="modal-top">
      <img height="80%" src={RestockStocks} alt="Restock stock view UI" />
    </div>
    <div className="modal-description">
      <div>
        <h2>RESTOCK</h2>
...
const WeatherModal = () => (
  <>
    <div className="modal-top">
      <img height="80%" src={WeatherUI} alt="Simple weather hover UI" />
    </div>
    <div className="modal-description">
      <div>
...
const Modals = ({ showModalId, resetModal }) => {
